"""
Spatial analysis of FAKE FP neurons for iteration 4.
...
# Save results
output_path = 'ml/results/iter4_fake_fp_spatial_analysis.csv'
df_results.to_csv(output_path, index=False)
print(f'\nResults saved to: {output_path}')

print(f'\n{"="*80}')
print('FINAL ITER4 CORRECTION COUNTS')
print('='*80)
print(f'FAKE FN (KEEP→DELETE): 86')
print(f'FAKE FP (DELETE→KEEP): {len(df_to_flip)} (excluding {merge_count} MERGE)')
print(f'Total corrections: {86 + len(df_to_flip)}')
