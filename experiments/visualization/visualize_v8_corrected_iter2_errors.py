"""
Visualize top 100 FP and FN errors from v8_corrected_iter2 model.
...
def visualize_errors(
    fp_csv='ml/results/v8_corrected_iter2_top100_fp.csv',
    fn_csv='ml/results/v8_corrected_iter2_top100_fn.csv',
    raw_dir='data/raw_compressed',
    output_dir='ml/results/v8_corrected_iter2_visualizations',
    neurons_per_page=5
):
    """Visualize top FP and FN neurons."""
    print('='*80)
    print('VISUALIZING v8_corrected_iter2 ERRORS')
    print('='*80)
    ...
    for page in range(n_fp_pages):
        ...
        fig.suptitle(
            f'FALSE POSITIVES iter2 (model says KEEP, should DELETE)\n'
    ...
    for page in range(n_fn_pages):
        ...
        fig.suptitle(
            f'FALSE NEGATIVES iter2 (model says DELETE, should KEEP)\n'
