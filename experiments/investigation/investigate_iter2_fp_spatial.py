"""
Investigate spatial relationships of FAKE FP cases from iter2.
...
print('='*80)
print('INVESTIGATING ITER2 FP SPATIAL RELATIONSHIPS')
print('='*80)

# Load datasets
df = pd.read_csv('ml/results/training_dataset_v8_corrected_iter2.csv')
df_fp = pd.read_csv('ml/results/v8_corrected_iter2_top100_fp.csv')

# Real FP (model wrong to KEEP): 5, 9, 12, 18, 53, 71
real_fp_indices = [5, 9, 12, 18, 53, 71]
...
output_df.to_csv('ml/results/iter2_fake_fp_spatial_analysis.csv', index=False)
print(f'\nDetailed analysis saved to: ml/results/iter2_fake_fp_spatial_analysis.csv')

# Generate corrections list for easy copy-paste
print(f'\n{"="*80}')
print('CORRECTIONS TO APPLY FOR ITER3')
print('='*80)
