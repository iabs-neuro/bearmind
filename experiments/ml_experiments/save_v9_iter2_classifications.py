"""
Save expert classifications for v9_iter2 corrections.
"""
import pandas as pd
import json

# Expert classifications from manual review
REAL_FP = [24, 45, 55, 58, 65, 79, 82, 90, 91]
REAL_FN = [3, 13, 14, 26, 41, 97, 99]

print('='*80)
print('V9 ITERATION 2 - EXPERT CLASSIFICATIONS')
print('='*80)
