...
- FAKE FP (90): PROXIMITY + STANDALONE only (NOT MERGE - those are real duplicates)
"""
import pandas as pd
import numpy as np

print('='*80)
print('APPLYING ITER3 CORRECTIONS TO v8_corrected_iter2 (FIXED)')
print('='*80)
...
print(f'Net change from iter2: {df["ground_truth"].sum() - 34210:+,} labels')
